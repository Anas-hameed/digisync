    ...
    return (
        <div className=" w-screen ">
            <div className="flex justify-center md:my-16">
                <div className="w-full max-w-md p-4 rounded-md shadow-2xl  border-2 border-gray-200 sm:p-8 dark:bg-gray-900 dark:text-gray-100">
                    ...
                    <div className="my-6 space-y-4">
                        ...
                        <button aria-label="Login with Twitter" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md bg-neutral-300 focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
