        ...
        >
            <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <div onClick={() => { navigate("/home"); }} className="flex-grow-[1] ml-5 md:ml-12">
                        <img src={MainLogo} className="w-[160px] md:w-[220px] cursor-pointer my-[5px]" alt="DigiSync Logo" />
                    </div>
                            ...
                            <div className="flex flex-col gap-2 md:flex-row items-center justify-center">
                                ...
                                {props?.config?.loggedIn ? (
                                    ...
                                    <Fragment>
                                        ...
                                        >
                                            <Link to="/signup" className="text-inherit no-underline md:mr-5 lg:mr-[40px]">
                                                <Button style={{ fontWeight: '600', textTransform: 'none', borderRadius: '25px', fontSize: '18px', fontFamily: 'Roboto' }}
                                                    kind={KIND.primary}
                                                    overrides={{
                                                        BaseButton: {
