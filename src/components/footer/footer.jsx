import FooterLogo from '../../media/Images/logo.png';
            ...
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <Link to="http://localhost:3000" className="flex items-center">
                        <img src={FooterLogo} className="mr-3 h-[50px]" alt="DigiSync Logo" />
                    </Link>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-600">
                            ...
                            <li>
                                <Link to="https://tailwindcss.com/" className="hover:underline">Solutions</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
