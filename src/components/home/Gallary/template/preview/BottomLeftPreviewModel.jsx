...
export default function BottomLeftPreviewModel({ previewIndex, data, setIsOpen }) {
              ...
              <div className="absolute top-0 left-0 px-6 py-12">
                <div className="relative">
                  <h4 style={{ "fontFamily": `${fonts[previewIndex].headingfont}` }}
                    className={`mb-3 text-[48px] font-bold tracking-tight text-gray-100 max-w-[700px] border-4 py-2 px-4`}
                  >
                    {Title}
                  </h4>
                  <p style={{ "fontFamily": `${fonts[previewIndex].paragraphfont1}` }}
                    className={`max-w-[700px]  text-[32px]  text-sm leading-normal text-gray-200`}>
                    {posterText[index]}
                  </p>
                </div>
              </div>
              <div className="absolute top-[35%] left-0 px-6">
              ...
              <div className="absolute bottom-8 right-0 px-6">
                <div className="relative flex flex-col">
                  ...
                  <p style={{ "fontFamily": `${fonts[previewIndex].paragraphfont3}` }}
                    className={`text-sm mt-2 text-[18px] text-gray-100 max-w-[700px]`}>
                    prompt: {prompt}
                  </p>
                </div>
                <div className="relative flex flex-col">
