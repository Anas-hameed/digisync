...
const SMSGeneration = () => {
    ...
    const [smsOutput, setSmsOutput] = useState('Greeting there,\n\n I am a bot.The key to creating effective marketing campaigns is to deliver value to your audience by providing relevant, informative, and engaging content that helps them solve a problem or meet a need.\n\n I am here to help you with your work. I can help you generate content. Please Provide a simple subject with some keyword and I will try my best to generate the quality content for your SMS marketing or email marketing needs \n\nRegards:\n your AI powered text generation Copilot\n\n');
    ...
    return (
        <div className="flex-1">
            <div className={`w-full p-10 rounded-lg border-[1px] border-slate-300`} >
                <div className="text-4xl text-bold text-black font-poppins " >SMS Generation</div>
                ...
                <div className='my-6 box-shadow-custom p-6 rounded-lg min-h-[400px]'>
                    <p className='font-poppins font-bold text-gray-600 text-[24px] underline'>Output SMS</p>
                    {
                        loading ? (
